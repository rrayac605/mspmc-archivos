package mx.gob.imss.cit.mspmcarchivos.security;
...
import mx.gob.imss.cit.mspmcarchivos.security.model.TokenInfoModel;
			...
			try {
				if (existeJWTToken(request)) {
					...
					if (info != null) {
						...
						response.sendError(HttpServletResponse.SC_FORBIDDEN, "Sin acceso");
						return;
					}
				} else {
					SecurityContextHolder.clearContext();
